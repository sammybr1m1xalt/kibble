...
def main(argv=None):
    ...
    parser.add_argument("--passphrase-file", type=Path,
                        default=Path("/home/anon/technocore-new/passphrase.txt"),
                        help="path to passphrase file (default: /home/anon/technocore-new/passphrase.txt)")
    parser.add_argument("--identity", type=Path,
                        default=Path("/home/anon/technocore-did-starter/identity.pem"),
                        help="path to identity.pem (default: repo root)")
    ...
    parser.add_argument("--no-claim", action="store_true",
                        help="post only the DELIVER, skip the CLAIM")
